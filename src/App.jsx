...
function App() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 h-screen w-screen p-3 flex flex-col justify-center items-center">
      <form
      ...
      >
        <a href="https://github.com/tanish-sukhija/chat-ai" target="_blank" rel="noopener noreferrer">
